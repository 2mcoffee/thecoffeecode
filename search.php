...
<main>
    <div class="row mb-4">
        <div class="col-md-8">
            <div class="mb-4">
                <h1><?php echo 'Resultados de búsqueda: <span class="text-blog">'.get_search_query().'</span>'; ?></h1>
            </div>
            <?php
            $posts_per_page = 10; 
            ...
            for ($i = 1; $i <= $search_query->max_num_pages; $i++) {
                if ($i == $paged) {
            ...
            ?>
            <?php else : ?>
                <p><?php esc_html_e('No se encontraron resultados para la búsqueda.'); ?></p>
            <?php endif; ?>
        </div>
